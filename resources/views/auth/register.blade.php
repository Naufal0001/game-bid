<x-guest-layout>
    <div class="fixed inset-0 w-full h-full bg-[#FFFBEB] flex items-center justify-center overflow-hidden font-sans">
        ...
        <div class="absolute top-0 right-0 w-64 h-full bg-yellow-300 border-l-4 border-black transform skew-x-12 origin-top-right z-0 pointer-events-none opacity-100"></div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-3">
                    ...
                    <div class="group">
                        <div class="bg-white border-[3px] border-black p-0 transition-all focus-within:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus-within:-translate-y-1">
                            <input id="name" class="block w-full border-none focus:ring-0 font-bold p-3 text-sm placeholder-gray-500 bg-transparent text-black" 
                                   type="text" name="name" :value="old('name')" 
                                   placeholder="Full Name" required autofocus autocomplete="name" />
                        </div>
                        <x-input-error :messages="$errors->get('name')" class="mt-1 font-bold text-xs text-red-600" />
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="group">
                            <div class="bg-white border-[3px] border-black p-0 transition-all focus-within:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus-within:-translate-y-1">
                                <input id="password_confirmation" class="block w-full border-none focus:ring-0 font-bold p-3 text-sm placeholder-gray-500 bg-transparent text-black"
                    ...
                    <button type="submit" class="w-full bg-pink-500 text-white font-black py-3 uppercase italic text-xl border-[4px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all active:scale-95 mt-2">
                        REGISTER NOW
                    </button>
                    ...
                    <div class="text-center font-bold text-xs mt-4">
                        ...
                        <a href="{{ route('login') }}" class="text-pink-600 hover:text-black bg-pink-100 px-1 border border-black ml-1 uppercase">
                            Log In Here
                        </a>
                    </div>
