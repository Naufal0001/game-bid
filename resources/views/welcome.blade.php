        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @forelse($auctions as $auction)
                ...
                <div class="h-48 bg-gray-100 border-2 border-black mb-4 flex items-center justify-center overflow-hidden">
                    <img src="{{ $auction->item->image ?? asset('images/placeholder.webp') }}" alt="{{ $auction->title ?? 'Item Misterius' }}" class="object-cover w-full h-full group-hover:scale-105 transition-transform duration-200">
                </div>
